...
export function getProductPaycode(id) {
  return request.get("/product/paycode/" + id, {}, { login: false });
}

export function getProductPaycodebyOrder(id) {
  return request.get("/product/paycodebyorder/" + id, {}, { login: false });
}
